...
public class Coffee_shopService {
    ...
    public String getCShops() {
...

        {
            ...
            LinkedList<Coffee_Shop> cs = db.getCoffeeShops();

            for(int i=0; i<cs.size(); i++) {

                sb.append("<tr><td>" + cs.get(i).getCid() + "</td><td>" + cs.get(i).getCoffeeName() + "</td><td>" + cs.get(i).getCoffeeAddress() + "</td><td>" + cs.get(i).getRawReview() + "</td><td>" + cs.get(i).getPhone() + "</td><td>" + cs.get(i).getUrl() + "</td></tr>");
